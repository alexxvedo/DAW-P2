...
javac -classpath "$TOMCAT_DIR/lib/servlet-api.jar" -d "$PROYECTO_DIR/WEB-INF/classes" "$PROYECTO_DIR/WEB-INF/classes/minitienda3/"*.java "$PROYECTO_DIR/WEB-INF/classes/minitienda3/helpers/"*.java
